...
var cTotalFrames = 18;
var cFrameWidth = 35;
var cImageSrc = 'resources/images/phone/sprites.png';
...
function startAnimation() {
	...
	document.getElementById('loaderImage').style.backgroundImage = 'url('
			+ cImageSrc + ')';
...
function continueAnimation() {
	...
	if (document.getElementById('loaderImage'))
		document.getElementById('loaderImage').style.backgroundPosition = (-cXpos)
				+ 'px 0';
